...
% The order and scale here is very important
input= [feed,...,              1) Feed rate
        spindle,...,           2) Spindle rate
        depth_cut,...,         3) Depth of cut
        cut_direction,...,     4) Cut direction
        cut_method,...,        5) Cut method
        ratio_cut,...,         6) Ratio cut
        length_cut_X,...,      7) Length of cut
        length_cut_Y,...,      8) 
        length_cut_Z,...,      9) 
        length_cut_XY,...,     10) 
        length_cut_XYZ,...,    11) 
